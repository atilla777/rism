...
--
-- Name: indicator_subkind_members; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.indicator_subkind_members (
    id bigint NOT NULL,
    indicator_id bigint,
    indicator_subkind_id bigint,
    created_at timestamp without time zone NOT NULL,
    updated_at timestamp without time zone NOT NULL
);
...
--
-- Name: indicator_subkind_members_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.indicator_subkind_members_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: indicator_subkind_members_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.indicator_subkind_members_id_seq OWNED BY public.indicator_subkind_members.id;


--
-- Name: indicator_subkinds; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.indicator_subkinds (
    id bigint NOT NULL,
    name character varying,
    codename character varying,
    indicators_kinds text[],
...
--
-- Name: indicator_subkinds_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.indicator_subkinds_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: indicator_subkinds_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.indicator_subkinds_id_seq OWNED BY public.indicator_subkinds.id;
...
CREATE TABLE public.indicators (
    ...
    content_kind integer,
    content_subkinds text,
    danger boolean,
    description text,
...
CREATE TABLE public.vulnerabilities (
    ...
    custom_relevance boolean DEFAULT false,
    actuality boolean DEFAULT false,
    custom_actuality boolean DEFAULT false,
...
ALTER TABLE ONLY public.indicator_subkind_members ALTER COLUMN id SET DEFAULT nextval('public.indicator_subkind_members_id_seq'::regclass);
...
ALTER TABLE ONLY public.indicator_subkinds ALTER COLUMN id SET DEFAULT nextval('public.indicator_subkinds_id_seq'::regclass);
...
--
-- Name: indicator_subkind_members_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.indicator_subkind_members
    ADD CONSTRAINT indicator_subkind_members_pkey PRIMARY KEY (id);


--
-- Name: indicator_subkinds_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.indicator_subkinds
    ADD CONSTRAINT indicator_subkinds_pkey PRIMARY KEY (id);
...
--
-- Name: index_indicator_subkind_members_on_indicator_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX index_indicator_subkind_members_on_indicator_id ON public.indicator_subkind_members USING btree (indicator_id);


--
-- Name: index_indicator_subkind_members_on_indicator_subkind_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX index_indicator_subkind_members_on_indicator_subkind_id ON public.indicator_subkind_members USING btree (indicator_subkind_id);
...
--
-- Name: fk_rails_053b3ff7a7; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: fk_rails_22c4962a98; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.indicator_subkind_members
    ADD CONSTRAINT fk_rails_22c4962a98 FOREIGN KEY (indicator_id) REFERENCES public.indicators(id);


--
-- Name: fk_rails_2313388e41; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: fk_rails_7c5eb38516; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.indicator_subkind_members
    ADD CONSTRAINT fk_rails_7c5eb38516 FOREIGN KEY (indicator_subkind_id) REFERENCES public.indicator_subkinds(id);
